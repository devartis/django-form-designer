    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('redirection_url', models.URLField(help_text='Leave blank if you would like to redirect to this page, otherwise it will redirect to a custom url.', max_length=255, null=True, verbose_name='redirect URL', blank=True)),
